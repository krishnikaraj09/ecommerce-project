  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand','Mamaearth','Hair & Care','Bajaj'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('Parachute Advansed Jasmine Coconut Hair Oil', 'assets/krishnika/hair/oil/hair oil1.webp', 5.7, 236, 204.00,),
    Product('Coconut Hair Oil', 'assets/krishnika/hair/oil/hair oil2.jpg', 6.7, 659, 150.00),
    Product('Bajaj Almond Drops Hair Oil', 'assets/krishnika/hair/oil/hair oil3.jpg', 5.1, 400, 240.00),
    Product('Dabur Amla Hair Oil', 'assets/krishnika/hair/oil/hair oil4.jpg', 3.0, 263, 215.00),
    Product('Hair & Care Green Fruits Hair Oil', 'assets/krishnika/hair/oil/hair oil5.jpg', 6.5, 453, 115.00),
  ];
