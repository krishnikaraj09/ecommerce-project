  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand','Tresemme','Streax'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('Tresemme Keratin Smooth Anti-Frizz Hair Serum', 'assets/krishnika/hair/hair serum/hair serum1.webp', 7.7, 336, 495.00,),
    Product('Streax Hair Serum', 'assets/krishnika/hair/hair serum/hair serum2.webp', 6.7, 659, 130.00),
    Product('Livon Serum Anti-frizz Serum', 'assets/krishnika/hair/hair serum/hair serum3.webp', 5.1, 400, 170.00),
    Product('Coconut & Squalane Nutri-Shine Hair Serum', 'assets/krishnika/hair/hair serum/hair serum4.webp', 5.0, 563, 475.00),
  ];
