  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand','Garnier','Revlon','L’Oreal'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('Garnier Color Naturals Nourishing Permanent Hair Color', 'assets/krishnika/hair/color/hair color1.jpg', 3.7, 136, 150.00,),
    Product('Revlon Hair Colour', 'assets/krishnika/hair/color/hair color2.jpg', 1.7, 139, 190.00),
    Product('Godrej hair Dark Brown Colour', 'assets/krishnika/hair/color/hair color3.jpg', 2.1, 100, 40.00),
    Product('L’Oreal Paris Hair Colour', 'assets/krishnika/hair/color/hair color4.jpg', 2.0, 163, 120.00),
  ];
