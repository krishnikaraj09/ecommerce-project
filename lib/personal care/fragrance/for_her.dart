  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand','Bella Vita Luxury','Fragrance & Beyond','HVNLY'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('Fragrance and Beyond Adore Eau De Perfume For Women', 'assets/krishnika/Frag/her/her1.jpg', 7.7, 336, 1499.00,),
    Product('Eau De Parfum Set for Women with Date, Senorita, Glam, Rose', 'assets/krishnika/Frag/her/her2.jpg', 6.7, 659, 690.00),
    Product('HVNLY Blossom Eau De Parfum For Women', 'assets/krishnika/Frag/her/her3.jpg', 6.1, 600, 475.00),
  ];
