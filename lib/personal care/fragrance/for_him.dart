...
class ForHim extends StatefulWidget {

  @override
  State<ForHim> createState() => _ForHimState();
}

class _ForHimState extends State<ForHim> {
  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand','Fragrance & Beyond','CALVIN KLEIN'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('Fragrance and Beyond Versus Eau De Parfum For Men', 'assets/krishnika/Frag/him/him1.jpg', 7.7, 336, 1499.00,),
    Product('Eternity For Men Parfum', 'assets/krishnika/Frag/him/him2.jpg', 6.7, 659, 4115.00),
  ];
