...
class RollOn extends StatefulWidget {

  @override
  State<RollOn> createState() => _RollOnState();
}

class _RollOnState extends State<RollOn> {
  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand','Be Bodywise','Nivea'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('Nivea Men Fresh Active Roll-On', 'assets/krishnika/Frag/roll on/roll on1.jpg', 4.7, 306, 215.00,),
    Product('Dove Eventone Deodorant Roll On', 'assets/krishnika/Frag/roll on/roll on2.jpg', 5.7, 559, 240.00),
    Product('Be Bodywise Underarm Liquid Roll On', 'assets/krishnika/Frag/roll on/roll on3.jpg', 6.1, 600, 399.00),
  ];
