...
class Shaving extends StatefulWidget {

  @override
  State<Shaving> createState() => _ShavingState();
}

class _ShavingState extends State<Shaving> {
  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand','Park Avenue'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('Park Avenue Luxury Grooming Collection', 'assets/krishnika/de/shaving/men1.jpg', 2.7, 336, 780.00,),
  ];
