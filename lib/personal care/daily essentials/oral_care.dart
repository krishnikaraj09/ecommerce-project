  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand','Himalaya','Colgate'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('BAMBOO TOOTHBRUSH', 'assets/krishnika/de/oral/oral1.webp', 3.7, 336, 149.00,),
    Product('Aara Naturals Bamboo Tongue Cleaner', 'assets/krishnika/de/oral/oral2.webp', 2.7, 359, 84.00),
    Product('Colgate Total Advance Health Toothpaste', 'assets/krishnika/de/oral/oral3.webp', 3.1, 400, 760.00),
    Product('Gilli Shopee Flexible Tongue Cleaner and Oral Care Finger Toothbrush', 'assets/krishnika/de/oral/oral4.webp', 2.0, 263, 325.00),
    Product('I2Cure Oral Care Gel', 'assets/krishnika/de/oral/oral5.webp', 1.5, 153, 252.00),
    Product('Himalaya HiOra Mouthwash Regular', 'assets/krishnika/de/oral/oral6.webp', 1.5, 103, 95.00),
  ];
