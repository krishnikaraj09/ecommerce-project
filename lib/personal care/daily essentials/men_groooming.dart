...
class MenGroooming extends StatefulWidget {

  @override
  State<MenGroooming> createState() => _MenGrooomingState();
}

class _MenGrooomingState extends State<MenGroooming> {
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('6-in-1 Electric Grooming Kit With LCD Display', 'assets/krishnika/de/men/mens2.jpg', 3.7, 436, 9127.00,),
    Product('Manicure Set Men Grooming Kit', 'assets/krishnika/de/men/mens3.webp', 3.7, 659, 2608.00),
  ];
