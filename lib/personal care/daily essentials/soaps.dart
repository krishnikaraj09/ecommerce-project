...
class Soaps extends StatefulWidget {

  @override
  State<Soaps> createState() => _SoapsState();
}

class _SoapsState extends State<Soaps> {
  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand','Lux','Dove','Pears'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('BOROPLUS Antiseptic + Moisturising Soap', 'assets/krishnika/de/soaps/soap1.webp', 7.7, 336, 34.00,),
    Product('Lux Rose & Vitamin E Soft Glowing Skin Soap Bar', 'assets/krishnika/de/soaps/soap2.webp', 6.7, 659, 100.00),
    Product('Dove Beauty Bar, White 4 oz, 14 bar', 'assets/krishnika/skin/facecreams/facecream3.webp', 5.1, 400, 4520.00),
    Product('Pears Soft & Fresh Soap', 'assets/krishnika/de/soaps/soap4.jpg', 2.0, 223, 62.00),
    Product('Cinthol Lime Soap', 'assets/krishnika/de/soaps/soap5.jpg', 3.5, 333, 34.00),
  ];
