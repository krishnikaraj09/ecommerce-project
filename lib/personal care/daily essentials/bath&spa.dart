...
class Bathspa extends StatefulWidget {

  @override
  State<Bathspa> createState() => _BathspaState();
}

class _BathspaState extends State<Bathspa> {
  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand','Mamaearth','Nivea','Lux'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('Lux Magical Orchid Bodywash', 'assets/krishnika/de/bath/bath1.webp', 3.7, 360, 93.00,),
    Product('NIVEA Frangipani & Oil Body Wash', 'assets/krishnika/de/bath/bath2.jpg', 6.7, 659, 259.00),
    Product('Coffee Body Wash', 'assets/krishnika/de/bath/bath3.webp', 4.1, 600, 279.00),
    Product('Everythin Plum Shower Gel by Plum BodyLovin', 'assets/krishnika/de/bath/bath4.webp', 7.0, 763, 380.00),
    Product('Murumuru Butter & Rose Body Wash', 'assets/krishnika/de/bath/bath5.webp', 7.5, 953, 500.00),
    Product('Salicylic Acid Body Wash', 'assets/krishnika/de/bath/bath6.webp', 3.5, 363, 349.00),
  ];
