...
class WomenHygiene extends StatefulWidget {

  @override
  State<WomenHygiene> createState() => _WomenHygieneState();
}

class _WomenHygieneState extends State<WomenHygiene> {
  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand','Stayfree','Vaginal wash'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('Stayfree Ultra Thin Sanitary Pads', 'assets/krishnika/de/women/women1.webp', 4.7, 336, 35.00,),
    Product('Vaginal wash', 'assets/krishnika/de/women/women2.png', 3.7, 359, 300.00),
    Product('Daily Natural Intimate Wash For Women', 'assets/krishnika/de/women/women3.webp', 3.1, 300, 180.00),
    Product('Women Emergency Kit', 'assets/krishnika/de/women/women4.webp', 4.0, 263, 699.00),
    Product('SheNeed Feminine Intimate Wipes', 'assets/krishnika/de/women/women5.webp', 2.5, 253, 200.00),
    Product('Whisper Ultra Hygiene+Comfort Sanitary Pads', 'assets/krishnika/de/women/women6.webp', 5.5, 543, 474.00),
  ];
