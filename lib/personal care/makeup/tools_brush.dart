...
class ToolsBrush extends StatefulWidget {

  @override
  State<ToolsBrush> createState() => _ToolsBrushState();
}

class _ToolsBrushState extends State<ToolsBrush> {
  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand','Mars','MAYCREATE'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('Professional Makeup Brushes Set', 'assets/krishnika/makeup/tools/tools1.jpg', 4.7, 336, 299.00,),
    Product('Picasso Makeup Spatula', 'assets/krishnika/makeup/tools/tools2.webp', 1.7, 259, 2934.00),
    Product('SKINPLUS Makeup Brush Set', 'assets/krishnika/makeup/tools/tools3.webp', 3.1, 300, 999.00),
    Product('Mapperz Foundation brush', 'assets/krishnika/makeup/tools/tools4.webp', 2.0, 263, 199.00),
  ];
