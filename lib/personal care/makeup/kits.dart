...
class Kits extends StatefulWidget {
  ...
  @override
  State<Kits> createState() => _KitsState();
}

class _KitsState extends State<Kits> {
  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand','Lakme','Swiss Beauty'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('Makeup Kit', 'assets/krishnika/makeup/kits/kits1.jpg', 7.7, 336, 1349.00,),
    Product('Makeup Kit', 'assets/krishnika/makeup/kits/kits2.jpg', 6.7, 659, 1490.00),
  ];
