  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand','Lakme','Plum','Swiss Beauty'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('Lakme 9 to 5 Eyeconic Liquid Eyeliner', 'assets/krishnika/makeup/eyes/eye1.jpg', 7.7, 336, 275.00,),
    Product('RENEE Extreme Stay Liquid Eyeliner', 'assets/krishnika/makeup/eyes/eye2.jpg', 6.7, 659, 450.00),
    Product('Lakme Eyeconic Kajal Twin', 'assets/krishnika/makeup/eyes/eye3.jpg', 5.1, 400, 399.00),
    Product('Plum Eye-Swear-By Kohl Kajal', 'assets/krishnika/makeup/eyes/eye4.jpg', 8.0, 963, 275.00),
    Product('MY TYA Nude Eyeshadow Makeup Kit', 'assets/krishnika/makeup/eyes/eye5.jpg', 7.5, 853, 500.00),
    Product('Swiss Beauty Ultimate Eyeshadow Plaette', 'assets/krishnika/makeup/eyes/eye6.jpg', 6.5, 703, 329.00),
    Product('Fashion Colour Professional Makeup Kit', 'assets/krishnika/makeup/eyes/eye7.jpg', 7.4, 600, 850.00),
    Product('Maybelline New York Lash Sensational Mascara', 'assets/krishnika/makeup/eyes/eye8.jpg', 7.0, 603, 549.00),
    Product('Lakmē Lash Boost Extreme Mascara', 'assets/krishnika/makeup/eyes/eye9.jpg', 4.5, 443, 849.00),
    Product('Flormar Eyebrow Pencil', 'assets/krishnika/makeup/eyes/eye10.jpg', 3.5, 463, 755.00),
  ];
