  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand','Minimalist','Dot & key','Plum','The Darma Co'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('Minimalist Niacinamide 10% Face Serum', 'assets/krishnika/skin/serums.jpg', 9.7, 1336, 599.00,),
    Product('Dot & Key Vitamin C Serum', 'assets/krishnika/skin/serums/serum1.jpg', 9.1, 1100, 695.00),
    Product('The derma co 10% Vitamin C Serum', 'assets/krishnika/skin/serums/serum2.jpg', 8.1, 900, 649.00),
    Product('Deconstruct Vitamin C & Ferulic Acid Serum', 'assets/krishnika/skin/serums/serum3.webp', 8.0, 1263, 799.00),
    Product('Mamaearth Face Correct Fae Serum', 'assets/krishnika/skin/serums/serum4.webp', 6.5, 953, 599.00),
    Product('Cetaphil Birth Healthy Radiance', 'assets/krishnika/skin/serums/serum5.jpg', 7.5, 663, 2299.00),
  ];
