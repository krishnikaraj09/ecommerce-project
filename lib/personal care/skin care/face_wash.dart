  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand','Cetaphil','Plum','Dot & key'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('Cetaphil Gentile Skin Cleanser', 'assets/krishnika/skin/facewash/facewash1.jpeg', 9.8, 1236, 399.00,),
    Product('The derma co 1% Salicylic acid Gel Face Wash', 'assets/krishnika/skin/facewash/face wash.jpg', 9.5, 1059, 299.00),
    Product('Plum 1% OAT & ALLANTION Face Wash', 'assets/krishnika/skin/facewash/facewash2.jpeg', 7.0, 829, 249.00),
    Product('Dot & Key Barrier Repair + Hidrating Face Wash', 'assets/krishnika/skin/facewash/facewash3.jpeg', 8.0, 963, 209.00),
    Product('Mamaearth Rice Face Wash', 'assets/krishnika/skin/facewash/facewash4.jpeg', 8.0, 763, 269.00),
    Product('Simple Refreshing Facial Wash', 'assets/krishnika/skin/facewash/facewash5.jpeg', 7.5, 963, 249.00),
  ];
