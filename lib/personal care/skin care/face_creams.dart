  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand','Mamaearth','Nivea','Good Vibes'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('Mamaearth Anti-pollution Face Cream', 'assets/krishnika/skin/facecreams/facecream1.jpg', 7.7, 336, 349.00,),
    Product('O3+ Whitening Cream', 'assets/krishnika/skin/facecreams/facecream2.webp', 6.7, 659, 490.00),
    Product('Biotique Winter Control Cream', 'assets/krishnika/skin/facecreams/facecream3.webp', 5.1, 400, 240.00),
    Product('Nivea Soft Cream', 'assets/krishnika/skin/facecreams/facecream4.webp', 6.0, 263, 440.00),
    Product('Himalaya winter Cream', 'assets/krishnika/skin/facecreams/facecream5.webp', 6.5, 953, 155.00),
    Product('Good Vibes Face Cream', 'assets/krishnika/skin/facecreams/facecream.jpg', 7.5, 663, 699.00),
  ];
