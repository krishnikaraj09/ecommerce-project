  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand','Mamaearth','Everyuth','Dove'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('Everyuth Naturals Exfoliating Walnut Scrub Gentle Face Scrub', 'assets/krishnika/skin/scrub/scrub1.jpg', 7.7, 336, 189.00,),
    Product('Tree Hut Watermelon Shea Sugar Exfoliating Body Scrub', 'assets/krishnika/skin/scrub/scrub2.jpg', 6.7, 659, 590.00),
    Product('mCaffeine Coffee Body Scrub', 'assets/krishnika/skin/scrub/scrub3.jpg', 5.1, 500, 449.00),
    Product('Dove Exfoliating Body Polish', 'assets/krishnika/skin/scrub/scrub4.jpg', 3.0, 163, 725.00),
  ];
