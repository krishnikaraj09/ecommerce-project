  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand','Mamaearth','Nivea','Dot & Key'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('NIVEA Body Lotion Natural Glow', 'assets/krishnika/skin/lotions/lotion1.jpg', 6.7, 936, 550.00,),
    Product('GOCARE Vanilla Body Milk', 'assets/krishnika/skin/lotions/lotion2.jpg', 5.7, 459, 249.00),
    Product('Dot & Key 72HR HYDRATING GEL', 'assets/krishnika/skin/lotions/lotion3.jpg', 7.1, 900, 495.00),
    Product('Vaseline Healthy Bright, Daily Brightening Daily Moisturizer', 'assets/krishnika/skin/lotions/lotion4.jpg', 6.0, 263, 435.00),
    Product('Cetaphil Moisturising Cream for Face & Body', 'assets/krishnika/skin/lotions/lotion5.jpg', 8.5, 853, 1299.00),
    Product('Plum BodyLovin Vanilla Caramello Body Lotion', 'assets/krishnika/skin/lotions/lotion6.jpg', 7.7, 863, 475.00),
  ];
