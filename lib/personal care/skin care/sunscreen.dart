  ...
  Widget _buildFilters() {
    return Row(
      ...
      children: [
        ...
        DropdownButton<String>(
          value: _brand,
          items: <String>['Brand','Deconstruct','VLCC','Dot & key'].map((String value) {
            return DropdownMenuItem<String>(
              value: value,
              child: Text(value),
            );
...
class _ProductGridState extends State<ProductGrid> {
  final List<Product> products = [
    Product('Deconstruct Mineral Sunscreen', 'assets/krishnika/skin/suns/sunscreen.jpeg', 9.7, 1336, 349.00,),
    Product('Ceramide &Vitamin C Sunscreen', 'assets/krishnika/skin/suns/sunscreen1.jpeg', 7.7, 1159, 499.00),
    Product('VLCC SPF 60 Sunscreen', 'assets/krishnika/skin/suns/sunscreen2.jpeg', 7.1, 800, 625.00),
    Product('Dot & Key Watermelon Cooling Sunscreen', 'assets/krishnika/skin/suns/sunscreen3.jpg', 8.0, 1263, 445.00),
    Product('Aqualogica Glow Tinted Sunscreen', 'assets/krishnika/skin/suns/sunscreen4.jpg', 7.5, 953, 699.00),
    Product('1% Hyaluronic Quick-Adsorbing Sunscreen', 'assets/krishnika/skin/suns/sunscreen5.jpg', 8.5, 1163, 699.00),
  ];
